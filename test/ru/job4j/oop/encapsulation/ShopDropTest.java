...
public class ShopDropTest {
    ...
    @Test
    public void whenDropSecondOutOfFive() {
        Product[] products = new Product[5];
        products[0] = new Product("Milk", 10);
        products[1] = new Product("Bread", 4);
        products[2] = new Product("Oyster", 53);
        products[3] = new Product("Meat", 44);
        products[4] = new Product("Сerial", 43);
        Product[] rsl = ShopDrop.leftShift(products, 1);
        assertThat(rsl[0].getName(), is("Milk"));
        assertThat(rsl[1].getName(), is("Oyster"));
        assertThat(rsl[2].getName(), is("Meat"));
        assertThat(rsl[3].getName(), is("Сerial"));
